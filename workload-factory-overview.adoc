...
NOTE: 帳戶系統管理員可以啟用或停用 AI 功能。如果系統管理員停用這些功能，「Ask Me」AI 助理將無法使用。link:manage-genai-features.html["了解如何管理人工智慧功能"]。
...
link:https://docs.netapp.com/us-en/workload-fsx-ontap/links-overview.html["深入瞭解連結"^]
